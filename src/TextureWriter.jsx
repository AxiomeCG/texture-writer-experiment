import {Center, Html, Plane, Text, useFBO, useTexture} from '@react-three/drei';
...
import {damp, damp2, dampAngle} from 'maath/easing';
...
export const TextureWriter = () => {
    ...
    useFrame((state, delta) => {
        ...
        points.current.material.uniforms.uTexture.value = texture;
